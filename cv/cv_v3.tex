...
\begin{tcolorbox}[
	...
	\begin{center}
		...
		\faPhone~ \textbf{+27 (0) 82 785 5983} \quad \faGithub~ \href{https://github.com/HenriBranken}{\textbf{GitHub}} \quad \faLinkedin~ \href{https://www.linkedin.com/in/henri-branken-1423a2153/}{\textbf{LinkedIn}} \quad \faLaptopCode~ \href{https://www.frontendmentor.io/profile/HenriBranken}{\textbf{FrontEndMentor}}
	\end{center}
\end{tcolorbox}
...
\begin{tcolorbox}[
	...
	Looking for a role in Web Development.
\end{tcolorbox}

\section*{Overview}
I am very eager to start a new role in Web Development, where I can build practical, user-focused applications and continue growing as a full-stack developer. To strengthen this path, I completed the HyperionDev Full Stack Web \& Software Engineer bootcamp, working with HTML, CSS, JavaScript, the MERN stack, and Java, and later served as a HyperionDev Coding Mentor (July~2024--March~2025).

My background also gives me a strong data and mathematics edge. I hold an MSc in Space Physics (\textit{cum laude}), which developed my research training, mathematical modeling ability, and scientific problem-solving skills. I subsequently spent approximately 3.5 years as a Data Scientist at Matogen Applied Insights, where I delivered a portfolio performance monitor and credit-loss model for a telecommunications client, a Power BI dashboard for agricultural nutrient distributions, and a grape harvest-date prediction model.
