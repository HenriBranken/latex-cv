...
\begin{tabularx}{\textwidth}{r l X}
    ...
    & \multicolumn{2}{|X}{\begin{tabular}{l r}
		...
		TCL Practical Music Grade 8 & 86\% \\
		Additional Mathematics (Probability, Data Handling \& Geometry) & 98\% \\
	\end{tabular}}\\ 
\end{tabularx}
