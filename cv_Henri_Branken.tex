...
\begin{minipage}{0.3\textwidth}
	\begin{tikzpicture}
		% Shadow for depth
		\shade[ball color=tealshade, inner color=tealshade, outer color=tealshade, draw=teal, thick] (0.2,-0.2) circle (2.3cm);
		
		% Circular clip for the image
		\clip (0,0) circle (2.3cm);
		\node[anchor=center] at (0,0) {\includegraphics[width=4.6cm]{cello_11a}};
	\end{tikzpicture}
\end{minipage}\\[0.5cm]
...
\begin{tabularx}{\textwidth}{r l X}
	...
	& \multicolumn{1}{| l}{\textbullet} & Completed the \textbf{``Data Science with Python'' Track} on DataCamp \href{https://github.com/HenriBranken/Henri_Branken_Certification/blob/master/online_courses/datacamp_dot_com/datacamp_Data_Scientist_with_Python_Track.pdf}{\textbf{(Certificate Number \#13,897)}}.\\
