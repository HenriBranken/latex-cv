...
\end{tabularx}
\textit{(A list of references may be supplied upon request)}
...
\begin{tabularx}{\textwidth}{r l X}
	...
	& \multicolumn{2}{|X}{\begin{tabular}{l r}
			English Home Language \dotfill & 81\% \\
			Afrikaans First Additional Language \dotfill & 91\% \\
			Mathematics \dotfill & 95\% \\
			Life Orientation \dotfill & 90\% \\
			Life Sciences \dotfill & 80\% \\
			Physical Sciences \dotfill & 86\% \\
			TCL Practical Music Grade 8 \dotfill & 86\% \\
			Probability, Data Handling \& Geometry \dotfill & 98\% \\
	\end{tabular}}\\ 
\end{tabularx}
